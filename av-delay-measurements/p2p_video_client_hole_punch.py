#python3 p2p_video_client_hole_punch_v2.py --server-ip 195.251.234.16 --local-port 5000 --peer-number 1
#python3 p2p_video_client_hole_punch_v2.py --server-ip 195.251.234.16 --local-port 5001 --peer-number 2
...
def start_p2p_client(server_ip, local_port, peer_number):
    ...
    if peer_number == 1:
        ...
        recv_command = [
            "gst-launch-1.0", "udpsrc", f"port={local_port}",
